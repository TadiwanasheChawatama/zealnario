...
from .models import Category, Collection, ProductSize, ProductColor, Product, ProductVariant, ProductDescription, ProductInstruction, ProductImage, ProductGallery,GalleryLike,ProductReview, Promotion, ProductPromotion, NewArrival
...
class ProductVariantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'size', 'color', 'size_name', 'color_name', 'sku', 'price_adjustment', 'stock_quantity', 'is_available', 'final_price'
        ]
...
class ProductGallerySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'image', 'comment', 'posted_by', 'posted_by_username', 'posted_at', 'likes_count', 'user_has_liked'
        ]
